...
<head>
  ...
  <script src='//libtl.com/sdk.js' data-zone='10588252' data-sdk='show_10588252'></script>
          ...
          <div class="card p-5">
            ...
            <div class="space-y-4">
              <div class="bg-gradient-to-r from-purple-900/30 to-green-900/30 p-4 rounded-xl border border-purple-500/20">
                ...
                <button onclick="show_10588252().then(rewardUser)" class="btn-primary w-full py-3">
                  <i class="fas fa-play mr-2"></i>Watch Ad Now
                </button>
              </div>
              
              <div class="bg-gradient-to-r from10588252-purple-900/30 to-blue-900/30 p-4 rounded-xl border border-blue-500/20">
                <div class="flex justify-between items-center mb-2">
